...
// batch删除客户
export const batchDeleteCustomer = async (data: Array<number>) => {
  return await request.delete({url: `/crm/customer/batchDelete`, data})
}
...
// 客户转移
export const batchTransferCustomer = async (data: Array<TransferReqVO>) => {
  return await request.put({url: '/crm/customer/batchTransfer', data})
}
