...
defineOptions({name: 'CrmBatchTransferForm'})
...
/** 打开弹窗 */
const open = async (ids: Array<number>) => {
...
const submitForm = async () => {
  ...
  try {
    ...
    const transferData: Array<TransferReqVO> = bizIds.value.map((bizId: number) => ({
      ...data,
      "id": bizId
    }))
...
const transfer = async (data: Array<TransferReqVO>) => {
  switch (props.bizType) {
    case BizTypeEnum.CRM_CLUE:
      return await ClueApi.batchTransferClue(data)
    case BizTypeEnum.CRM_CUSTOMER:
      return await CustomerApi.batchTransferCustomer(data)
    case BizTypeEnum.CRM_CONTACT:
      return await ContactApi.batchTransferContact(data)
    case BizTypeEnum.CRM_BUSINESS:
      return await BusinessApi.batchTransferBusiness(data)
    case BizTypeEnum.CRM_CONTRACT:
      return await ContractApi.batchTransferContract(data)
    default:
